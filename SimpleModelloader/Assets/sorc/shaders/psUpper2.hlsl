...
float4 main(PixelShaderInput IN) : SV_TARGET
{
	...
	float4 mix1 = lerp(diffuseMapColor, float4(0.025290, 0.051334, 0.379003, 1.000000), interpolationMapSample.r);
	float4 mix2 = lerp(mix1, float4(0.043735, 0.043735, 0.043735, 1.000000), interpolationMapSample.b);
	float4 finalDiffuse = lerp(float4(0.043107, 0.043107, 0.043107, 1.000000), mix2, interpolationMapSample.g);
